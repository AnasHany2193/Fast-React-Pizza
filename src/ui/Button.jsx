...
function Button({ children, disabled, type, to, onClick }) {
  ...
  const styles = {
    ...
    secondary:
      "inline-block text-sm font-semibold tracking-wide uppercase transition-colors duration-300 border-2 border-stone-300 rounded-full text-stone-400 hover:bg-stone-300 focus:bg-stone-300 focus:outline-none focus:ring focus:ring-stone-200 focus:ring-offset-2 disabled:cursor-not-allowed px-4 py-2.5 md:px-6 md:py-3.5 hover:text-stone-800 focus:text-stone-800",
    small: base + " " + "px-4 py-2 md:px-5 md:py-2.5 text-xs",
    round: base + " " + "px-2.4 py-1 md:px-3.5 md:py-2 text-sm ",
  };
